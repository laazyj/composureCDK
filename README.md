...
| [`@composurecdk/bedrock`](https://www.npmjs.com/package/@composurecdk/bedrock)                   | ![npm downloads](https://img.shields.io/npm/dm/@composurecdk/bedrock?labelColor=b85416&color=0f0d0c)          | Bedrock model access: cross-Region inference grants and alarms           |
| [`@composurecdk/bedrockagentcore`](https://www.npmjs.com/package/@composurecdk/bedrockagentcore) | ![npm downloads](https://img.shields.io/npm/dm/@composurecdk/bedrockagentcore?labelColor=b85416&color=0f0d0c) | Bedrock AgentCore: agent runtimes, memory, gateways and evaluations      |
...
| [`@composurecdk/cloudwatch`](https://www.npmjs.com/package/@composurecdk/cloudwatch)             | ![npm downloads](https://img.shields.io/npm/dm/@composurecdk/cloudwatch?labelColor=b85416&color=0f0d0c)       | CloudWatch alarm policies, naming and builder machinery                  |
| [`@composurecdk/custom-resources`](https://www.npmjs.com/package/@composurecdk/custom-resources) | ![npm downloads](https://img.shields.io/npm/dm/@composurecdk/custom-resources?labelColor=b85416&color=0f0d0c) | Compose-native `AwsCustomResource` builder for no-CFN-resource SDK calls |
...
| [`@composurecdk/kms`](https://www.npmjs.com/package/@composurecdk/kms)                           | ![npm downloads](https://img.shields.io/npm/dm/@composurecdk/kms?labelColor=b85416&color=0f0d0c)              | KMS customer-managed key components with well-architected defaults       |
