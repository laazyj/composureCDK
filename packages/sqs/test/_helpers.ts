...
/**
 * Sets a prop that the builder's role-typed surface excludes, mimicking
 * an untyped (JavaScript) caller — used to exercise the build-time
 * guards behind the compile-time exclusions.
 */
